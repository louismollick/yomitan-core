...
export const latinTransforms: LanguageTransformDescriptor<Condition> = {
    language: 'la',
    conditions,
    transforms: {
        plural: {
        ...
        feminine: {
            ...
            rules: [suffixInflection('a', 'us', ['adj12'], ['adj12'])],
        },
        neuter: {
            name: 'neuter',
            description: 'Adjective form',
            rules: [suffixInflection('um', 'us', ['adj12'], ['adj12'])],
        },
        ablative: {
            name: 'ablative',
            description: 'Ablative case',
            rules: [suffixInflection('o', 'um', ['n2s'], ['n2s'])],
        },
    },
};
