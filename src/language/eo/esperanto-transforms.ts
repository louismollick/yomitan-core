...
export const esperantoTransforms: LanguageTransformDescriptor<Condition> = {
    language: 'eo',
    conditions,
    transforms: {
        // general inflections
        accusative: {
            ...
            rules: [suffixInflection('n', '', [], [])],
        },
        plural: {
            name: 'plural',
            description: 'Plural form of a word',
            rules: [suffixInflection('j', '', [], [])],
        },
        diminutive: {
            name: 'diminutive',
            description: 'Diminutive form of a noun',
            rules: [suffixInflection('eto', 'o', [], ['n'])],
        },
        directional: {
            name: 'directional',
            description: ['An adverb in accusative case indicates direction', 'kie: where', 'kien: to where'].join(
                '\n',
            ),
            rules: [suffixInflection('en', 'e', [], ['adv'])],
        },
        locational: {
            name: 'locational',
            description: [
        ...
        '-ejo (noun)': {
            ...
            rules: [suffixInflection('ejo', 'o', [], ['n'])],
        },
        '-ejo (verb)': {
            name: '-ejo',
            description: [
            ...
            rules: [suffixInflection('ejo', 'i', [], ['v'])],
        },
        '-ujo (noun)': {
            name: '-ujo',
            description: [
            ...
            rules: [suffixInflection('ujo', 'o', [], ['n'])],
        },
        '-ujo (adjective)': {
            name: '-ujo',
            description: [
            ...
            rules: [suffixInflection('ujo', 'a', [], ['adj'])],
        },
        '-ujo (verb)': {
            name: '-ujo',
            description: [
            ...
            rules: [suffixInflection('ujo', 'i', [], ['v'])],
        },
        '-ebla': {
            name: '-ebla',
            description: [
            ...
            rules: [suffixInflection('ebla', 'i', [], ['v'])],
        },
        '-ado': {
            name: '-ado',
            description: [
        ...
        'kun-': {
            ...
            rules: [prefixInflection('kun', '', [], [])],
        },
        'ekster-': {
            name: 'ekster-',
            description: ['Prefix meaning "outside of"', 'lando: country', 'eksterlando: foreign country'].join('\n'),
            rules: [prefixInflection('ekster', '', [], [])],
        },
        'ek-': {
            name: 'ek-',
            description: ['Prefix meaning to begin the action', 'kanti: to sing', 'ekkanti: to begin to sing'].join(
                '\n',
            ),
            rules: [prefixInflection('ek', '', [], [])],
        },
        'ĵus-': {
            name: 'ĵus-',
            description: [
