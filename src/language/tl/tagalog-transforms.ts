...
import { prefixInflection, suffixInflection, wholeWordInflection } from '../language-transforms';
...
export function hyphenatedInflection(conditionsIn: Condition[], conditionsOut: Condition[]): Rule<Condition> {
    const regex = /-/;
    return {
        type: 'prefix',
        isInflected: regex,
...
export function suffixInflectionWithOtoUSoundChange(
...
export function prefixInflectionWithRep1(
...
export function sandwichInflection(
    inflectedPrefix: string,
    deinflectedPrefix: string,
    inflectedSuffix: string,
    deinflectedSuffix: string,
    ...
    return {
        ...
        isInflected: regex,
        deinflect: (text) =>
            deinflectedPrefix + text.slice(inflectedPrefix.length, -inflectedSuffix.length) + deinflectedSuffix,
        conditionsIn,
        conditionsOut,
    };
}

export function sandwichInflectionWithOtoUSoundChange(
    inflectedPrefix: string,
    deinflectedPrefix: string,
    inflectedSuffix: string,
    deinflectedSuffix: string,
...
export const tagalogTransforms: LanguageTransformDescriptor<Condition> = {
    language: 'tl',
    conditions,
    transforms: {
        hyphenated: {
        ...
        'ma-': {
            name: 'ma-',
            rules: [prefixInflection('ma', '', [], ['n', 'adj']), prefixInflection('mar', 'd', [], ['n', 'adj'])],
        },
        'pang-': {
            name: 'pang-',
            rules: [
        ...
        'ka-': {
            name: 'ka-',
            rules: [prefixInflection('ka', '', [], ['n', 'adj']), prefixInflection('kar', 'd', [], ['n', 'adj'])],
        },
        'kaka-': {
            name: 'kaka-',
            rules: [
        ...
        'mag-': {
            name: 'mag-',
            rules: [prefixInflection('mag', '', [], ['n'])],
        },
        'mag- + rep1': {
            name: 'mag- + rep1',
            rules: [prefixInflectionWithRep1('mag', '', [], ['n'])],
        },
        'magka-': {
            name: 'magka-',
            rules: [prefixInflection('magka', '', [], ['n', 'adj']), prefixInflection('magkar', 'd', [], ['n', 'adj'])],
        },
        'magkaka-': {
            name: 'magkaka-',
            rules: [
        ...
        'pa-': {
            name: 'pa-',
            rules: [prefixInflection('pa', '', [], ['n', 'adj']), prefixInflection('par', 'd', [], ['n', 'adj'])],
        },
        'pa-...-an': {
            name: 'pa-...-an',
            rules: [
        ...
        'pag-': {
            name: 'pag-',
            rules: [prefixInflection('pag', '', [], ['n'])],
        },
        'pag- + rep1': {
            name: 'pag- + rep1',
            rules: [prefixInflectionWithRep1('pag', '', [], ['n'])],
        },
        'pagka-': {
            name: 'pagka-',
            rules: [
        ...
        'pakikipag-': {
            name: 'pakikipag-',
            rules: [prefixInflection('pakikipag', '', [], ['n'])],
        },
        'pang- + rep1': {
            name: 'pang- + rep1',
            rules: [
        ...
        'tag-': {
            name: 'tag-',
            rules: [prefixInflection('tag', '', [], ['n'])],
        },
        'taga-': {
            name: 'taga-',
            rules: [prefixInflection('taga', '', [], ['n'])],
        },
        'tagapag-': {
            name: 'tagapag-',
            rules: [prefixInflection('tagapag', '', [], ['n'])],
        },
        'tagapang-': {
            name: 'tagapang-',
            rules: [
        ...
        'ipa-': {
            name: 'ipa-',
            rules: [prefixInflection('ipa', '', [], ['n'])],
        },
        'ipag-': {
            name: 'ipag-',
            rules: [prefixInflection('ipag', '', [], ['n'])],
        },
        'ipag- + rep1': {
            name: 'ipag- + rep1',
            rules: [prefixInflectionWithRep1('ipag', '', [], ['n'])],
        },
        'ipang-': {
            name: 'ipang-',
            rules: [
        ...
        'magkanda-': {
            name: 'magkanda-',
            rules: [prefixInflection('magkanda', '', [], ['n']), prefixInflection('magkandar', 'd', [], ['n'])],
        },
        'magma-': {
            name: 'magma-',
            rules: [prefixInflection('magma', '', [], ['n']), prefixInflection('magmar', 'd', [], ['n'])],
        },
        'magpa-': {
            name: 'magpa-',
            rules: [prefixInflection('magpa', '', [], ['n']), prefixInflection('magpar', 'd', [], ['n'])],
        },
        'magpaka-': {
            name: 'magpaka-',
            rules: [prefixInflection('magpaka', '', [], ['n']), prefixInflection('magpakar', 'd', [], ['n'])],
        },
        'magsi-': {
            name: 'magsi-',
            rules: [prefixInflection('magsi', '', [], ['n']), prefixInflection('magsipag', '', [], ['n'])],
        },
        'makapang-': {
            name: 'makapang-',
            rules: [
        ...
        'makapag-': {
            name: 'makapag-',
            rules: [prefixInflection('makapag', '', [], ['n'])],
        },
        'maka-': {
            name: 'maka-',
            rules: [prefixInflection('maka', '', [], ['n', 'adj']), prefixInflection('makar', 'd', [], ['n', 'adj'])],
        },
        'maki-': {
            name: 'maki-',
            rules: [prefixInflection('maki', '', [], ['n']), prefixInflection('makir', 'd', [], ['n'])],
        },
        'makipag-': {
            name: 'makipag-',
            rules: [prefixInflection('makipag', '', [], ['n'])],
        },
        'makipag-...-an': {
            name: 'makipag-...-an',
            rules: [
        ...
        'mapa-': {
            name: 'mapa-',
            rules: [prefixInflection('mapa', '', [], ['n']), prefixInflection('mapar', 'd', [], ['n'])],
        },
        'pa-...-in': {
            name: 'pa-...-in',
            rules: [
        ...
        'mapag-': {
            name: 'mapag-',
            rules: [prefixInflection('mapag', '', [], ['n', 'adj'])],
        },
        'naka-': {
            name: 'naka-',
            rules: [prefixInflection('naka', '', [], ['n', 'adj']), prefixInflection('nakar', 'd', [], ['n', 'adj'])],
        },
        'nakaka-': {
            name: 'nakaka-',
            rules: [
        ...
        'naka- + rep1': {
            name: 'naka- + rep1',
            rules: [prefixInflectionWithRep1('naka', '', [], ['n', 'adj'])],
        },
        'nakapang- + rep1': {
            name: 'nakapang- + rep1',
            rules: [
        ...
        'pala-': {
            name: 'pala-',
            rules: [prefixInflection('pala', '', [], ['n', 'adj']), prefixInflection('palar', 'd', [], ['n', 'adj'])],
        },
        '-ng': {
            name: 'ng',
            rules: [suffixInflection('ng', '', [], [])],
        },
    },
};
