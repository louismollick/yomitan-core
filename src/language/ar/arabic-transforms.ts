...
function getImperfectPrefixes(prefix: string, includeLiPrefix = true): string[] {
    return [
        `${prefix}`,
        `و${prefix}`,
        `ف${prefix}`,
...
export const arabicTransforms: LanguageTransformDescriptor<Condition> = {
    language: 'ar',
    conditions,
    transforms: {
        // Noun
        'NPref-Wa': {
            ...
            rules: [prefixInflection('و', '', ['n_wa'], ['n']), prefixInflection('ف', '', ['n_wa'], ['n'])],
        },
        'NPref-Bi': {
            name: 'by, with',
            description: 'by, with',
        ...
        'NSuff-ap': {
            name: 'fem. sg.',
            description: 'fem. sg.',
            rules: [suffixInflection('ة', '', ['n_s'], ['n_p', 'n'])],
        },
        'NSuff-ath': {
        ...
        'NSuff-ayn': {
            ...
            rules: [suffixInflection('ين', '', ['n_s'], ['n_p', 'n'])],
        },
        'NSuff-ayh': {
            name: 'dual + pos. pron.',
            ...
            rules: [
                ...
                ...nonAssimilatingPossessivePronouns.map((p) =>
                    suffixInflection(`ي${p}`, '', ['n_s'], ['n_indef', 'n']),
                ),
            ],
        },
        'NSuff-atAn': {
        ...
        'NSuff-tayh': {
            ...
            rules: [
                ...
                ...nonAssimilatingPossessivePronouns.map((p) =>
                    suffixInflection(`تي${p}`, '', ['n_s'], ['n_indef', 'n']),
                ),
                ...nonAssimilatingPossessivePronouns.map((p) =>
                    suffixInflection(`تي${p}`, 'ة', ['n_s'], ['n_indef', 'n']),
                ),
            ],
        },
        'NSuff-At': {
        ...
        'NSuff-wn': {
            ...
            rules: [suffixInflection('ون', '', ['n_s'], ['n_nom', 'n'])],
        },
        'NSuff-wh': {
            name: 'm. pl + pos. pron.',
            ...
            rules: [
                ...
                ...nonAssimilatingPossessivePronouns.map((p) =>
                    suffixInflection(`و${p}`, '', ['n_s'], ['n_nom_indef', 'n']),
                ),
            ],
        },
        'NSuff-iyn': {
        ...
        'PVSuff-n': {
            ...
            rules: [
                ...
                ...directObjectPronouns.map((p) =>
                    conditionalSuffixInflection(`ن${p}`, '', '(?<!ن)', ['pv_s'], ['pv']),
                ),

                conditionalSuffixInflection('نا', '', '(?<!ن)', ['pv_s'], ['pv']),
                ...directObjectPronouns2nd.map((p) =>
                    conditionalSuffixInflection(`نا${p}`, '', '(?<!ن)', ['pv_s'], ['pv']),
                ),
                ...directObjectPronouns3rd.map((p) =>
                    conditionalSuffixInflection(`نا${p}`, '', '(?<!ن)', ['pv_s'], ['pv']),
                ),
        ...
        'PVSuff-t': {
            ...
            rules: [
                ...
                ...directObjectPronouns1st.map((p) =>
                    conditionalSuffixInflection(`تما${p}`, '', '(?<!ت)', ['pv_s'], ['pv']),
                ),
                ...directObjectPronouns3rd.map((p) =>
                    conditionalSuffixInflection(`تما${p}`, '', '(?<!ت)', ['pv_s'], ['pv']),
                ),
                ...
                ...directObjectPronouns1st.map((p) =>
                    conditionalSuffixInflection(`تمو${p}`, '', '(?<!ت)', ['pv_s'], ['pv']),
                ),
                ...directObjectPronouns3rd.map((p) =>
                    conditionalSuffixInflection(`تمو${p}`, '', '(?<!ت)', ['pv_s'], ['pv']),
                ),
                ...
                ...directObjectPronouns1st.map((p) =>
                    conditionalSuffixInflection(`تن${p}`, '', '(?<!ت)', ['pv_s'], ['pv']),
                ),
                ...directObjectPronouns3rd.map((p) =>
                    conditionalSuffixInflection(`تن${p}`, '', '(?<!ت)', ['pv_s'], ['pv']),
                ),
