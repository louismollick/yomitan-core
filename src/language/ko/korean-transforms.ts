...
export const koreanTransforms: LanguageTransformDescriptor<Condition> = {
    language: 'ko',
    conditions,
    transforms: {
        어간: {
        ...
        '-거라': {
            name: '-거라',
            rules: [suffixInflection('ㄱㅓㄹㅏ', 'ㄷㅏ', [], ['v'])],
        },
        '-건': {
            name: '-건',
            rules: [
        ...
        '-게나': {
            name: '-게나',
            rules: [suffixInflection('ㄱㅔㄴㅏ', 'ㄷㅏ', [], ['v']), suffixInflection('ㄱㅔㄴㅏ', '', [], ['eusi'])],
        },
        '-게시리': {
            name: '-게시리',
            rules: [
        ...
        '-곤': {
            name: '-곤',
            rules: [suffixInflection('ㄱㅗㄴ', 'ㄷㅏ', [], ['v', 'adj']), suffixInflection('ㄱㅗㄴ', '', [], ['eusi'])],
        },
        '-고도': {
            name: '-고도',
            rules: [
        ...
        '-고야': {
            name: '-고야',
            rules: [suffixInflection('ㄱㅗㅇㅑ', 'ㄷㅏ', [], ['v']), suffixInflection('ㄱㅗㅇㅑ', '', [], ['eusi'])],
        },
        '-고자': {
            name: '-고자',
            rules: [
        ...
        '-기로': {
            name: '-기로',
            rules: [suffixInflection('ㄱㅣㄹㅗ', 'ㄷㅏ', [], ['v', 'adj', 'ida'])],
        },
        '-기로니': {
            name: '-기로니',
            rules: [suffixInflection('ㄱㅣㄹㅗㄴㅣ', 'ㄷㅏ', [], ['v', 'adj', 'ida'])],
        },
        '-기로서': {
            name: '-기로서',
            rules: [
        ...
        '-너라': {
            name: '-너라',
            rules: [suffixInflection('ㄴㅓㄹㅏ', 'ㄷㅏ', [], ['v'])],
        },
        '-네': {
            name: '-네',
            rules: [
        ...
        '-노라': {
            name: '-노라',
            rules: [suffixInflection('ㄴㅗㄹㅏ', 'ㄷㅏ', [], ['v']), suffixInflection('ㄴㅗㄹㅏ', '', [], ['p', 'f'])],
        },
        '-노라고': {
            name: '-노라고',
            rules: [suffixInflection('ㄴㅗㄹㅏㄱㅗ', 'ㄷㅏ', [], ['v'])],
        },
        '-노라니': {
            name: '-노라니',
            rules: [suffixInflection('ㄴㅗㄹㅏㄴㅣ', 'ㄷㅏ', [], ['v', 'adj'])],
        },
        '-노라니까': {
            name: '-노라니까',
            rules: [suffixInflection('ㄴㅗㄹㅏㄴㅣㄲㅏ', 'ㄷㅏ', [], ['v', 'adj'])],
        },
        '-노라면': {
            name: '-노라면',
            rules: [
        ...
        '-누': {
            name: '-누',
            rules: [suffixInflection('ㄴㅜ', 'ㄷㅏ', [], ['v', 'adj']), suffixInflection('ㄴㅜ', '', [], ['p', 'f'])],
        },
        '-누나': {
            name: '-누나',
            rules: [suffixInflection('ㄴㅜㄴㅏ', 'ㄷㅏ', [], ['v']), suffixInflection('ㄴㅜㄴㅏ', '', [], ['eusi'])],
        },
        '-누만': {
            name: '-누만',
            rules: [
        ...
        '-느니만': {
            name: '-느니만',
            rules: [suffixInflection('ㄴㅡㄴㅣㅁㅏㄴ ㅁㅗㅅㅎㅏㄷㅏ', 'ㄷㅏ', ['v'], ['v', 'adj'])],
        },
        '-느라': {
            name: '-느라',
            rules: [suffixInflection('ㄴㅡㄹㅏ', 'ㄷㅏ', [], ['v']), suffixInflection('ㄴㅡㄹㅏ', '', [], ['eusi'])],
        },
        '-느라고': {
            name: '-느라고',
            rules: [
        ...
        '-는도다': {
            name: '-는도다',
            rules: [suffixInflection('ㄴㅡㄴㄷㅗㄷㅏ', 'ㄷㅏ', [], ['v'])],
        },
        '-(으/느)ㄴ바': {
            name: '-(으/느)ㄴ바',
            rules: [
        ...
        '-다': {
            name: '-다',
            rules: [suffixInflection('ㄷㅏ', '', [], ['p', 'f', 'eusi', 'ida'])],
        },
        '-다가': {
            name: '-다가',
            rules: [
        ...
        '-던들': {
            name: '-던들',
            rules: [suffixInflection('ㄷㅓㄴㄷㅡㄹ', '', [], ['p'])],
        },
        '-던바': {
            name: '-던바',
            rules: [
        ...
        '-드라면': {
            name: '-드라면',
            rules: [suffixInflection('ㄷㅡㄹㅏㅁㅕㄴ', '', [], ['p'])],
        },
        '-드래도': {
            name: '-드래도',
            rules: [
        ...
        '-든들': {
            name: '-든들',
            rules: [suffixInflection('ㄷㅡㄴㄷㅡㄹ', '', [], ['p'])],
        },
        '-든지': {
            name: '-든지',
            rules: [
        ...
        '-세나': {
            name: '-세나',
            rules: [suffixInflection('ㅅㅔㄴㅏ', 'ㄷㅏ', [], ['v'])],
        },
        '-(으)세요': {
            name: '-(으)세요',
            rules: [
        ...
        '-소': {
            name: '-소',
            rules: [suffixInflection('ㅅㅗ', 'ㄷㅏ', [], ['v', 'adj']), suffixInflection('ㅅㅗ', '', [], ['p', 'f'])],
        },
        '-소다': {
            name: '-소다',
            rules: [
        ...
        '-자': {
            name: '-자',
            rules: [suffixInflection('ㅈㅏ', 'ㄷㅏ', [], ['v', 'ida'])],
        },
        '-자고': {
            name: '-자고',
            rules: [suffixInflection('ㅈㅏㄱㅗ', 'ㄷㅏ', [], ['v'])],
        },
        '-자구': {
            name: '-자구',
            rules: [suffixInflection('ㅈㅏㄱㅜ', 'ㄷㅏ', [], ['v'])],
        },
        '-자꾸나': {
            name: '-자꾸나',
            rules: [suffixInflection('ㅈㅏㄲㅜㄴㅏ', 'ㄷㅏ', [], ['v'])],
        },
        '-자느니': {
            name: '-자느니',
            rules: [suffixInflection('ㅈㅏㄴㅡㄴㅣ', 'ㄷㅏ', [], ['v'])],
        },
        '-자니까': {
            name: '-자니까',
            rules: [suffixInflection('ㅈㅏㄴㅣㄲㅏ', 'ㄷㅏ', [], ['v'])],
        },
        '-자마자': {
            name: '-자마자',
            rules: [
        ...
        '-자며': {
            name: '-자며',
            rules: [suffixInflection('ㅈㅏㅁㅕ', 'ㄷㅏ', [], ['v'])],
        },
        '-자면': {
            name: '-자면',
            rules: [suffixInflection('ㅈㅏㅁㅕㄴ', 'ㄷㅏ', [], ['v'])],
        },
        '-자면서': {
            name: '-자면서',
            rules: [suffixInflection('ㅈㅏㅁㅕㄴㅅㅓ', 'ㄷㅏ', [], ['v'])],
        },
        '-자손': {
            name: '-자손',
            rules: [suffixInflection('ㅈㅏㅅㅗㄴ', 'ㄷㅏ', [], ['v'])],
        },
        '-자오': {
            name: '-자오',
            rules: [suffixInflection('ㅈㅏㅇㅗ', 'ㄷㅏ', ['jao'], ['v'])],
        },
        '-자옵': {
            name: '-자옵',
            rules: [suffixInflection('ㅈㅏㅇㅗㅂ', 'ㄷㅏ', ['jaob'], ['v'])],
        },
        '-잡': {
            name: '-잡',
            rules: [suffixInflection('ㅈㅏㅂ', 'ㄷㅏ', ['jab'], ['v'])],
        },
        '-죠': {
            name: '-죠',
            rules: [
