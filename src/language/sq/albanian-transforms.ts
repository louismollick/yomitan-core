...
function conjugationIISuffixInflection(
...
export const albanianTransforms: LanguageTransformDescriptor<Condition> = {
    language: 'sq',
    conditions,
    transforms: {
        // Nouns
        ...
        'singular definite accusative': {
            ...
            rules: [suffixInflection('n', '', [], ['n'])],
        },
        plural: {
            name: 'plural',
            description: 'Plural form of a noun',
            rules: [suffixInflection('e', '', ['np'], ['ns']), suffixInflection('t', '', ['np'], ['ns'])],
        },
        // Verbs
        ...
        'imperative second-person singular present': {
            ...
            rules: [suffixInflection('o', 'oj', [], ['v']), suffixInflection('hu', 'hem', [], ['v'])],
        },
        ...
        mediopassive: {
            ...
            rules: [suffixInflection('hem', 'h', ['v'], ['v']), suffixInflection('hem', 'j', ['v'], ['v'])],
        },
        'optative first-person singular present': {
            ...
            rules: [suffixInflection('fsha', 'j', [], ['v'])],
        },
        'optative second-person singular present': {
            ...
            rules: [suffixInflection('fsh', 'j', [], ['v'])],
        },
        'optative third-person singular present': {
            ...
            rules: [suffixInflection('ftë', 'j', [], ['v'])],
        },
        'optative first-person plural present': {
            ...
            rules: [suffixInflection('fshim', 'j', [], ['v'])],
        },
        'optative second-person plural present': {
            ...
            rules: [suffixInflection('fshi', 'j', [], ['v'])],
        },
        'optative third-person plural present': {
            ...
            rules: [suffixInflection('fshin', 'j', [], ['v'])],
        },
        nominalization: {
            name: 'nominalization',
